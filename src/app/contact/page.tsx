...
const socials = [
  { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/eventsfactoryrw/" },
  { icon: Facebook, label: "Facebook", href: "https://www.facebook.com/eventsfactoryrwanda" },
  { icon: LinkedInIcon, label: "LinkedIn", href: "https://www.linkedin.com/company/events-factory-rwanda/" },
  { icon: FlickrIcon, label: "Flickr", href: "https://www.flickr.com/people/199472815@N07/" },
  { icon: TikTokIcon, label: "TikTok", href: "https://www.tiktok.com/@eventsfactoryrw" },
];
