...
const services = [
  ...
  },
  {
    ...
    title: 'Venue Sourcing & Destination Management',
    description:
...
const process = [
  {
    ...
    title: 'Brief',
    description:
      'Tell us your vision, budget, and goals. We listen and ask the right questions.',
  },
  {
    step: '02',
    title: 'Design',
    description:
      'Our creative team develops a bespoke concept and detailed event proposal.',
  },
  {
    step: '03',
    title: 'Execute',
    description:
      'We handle every detail with precision — from setup to the last guest leaving.',
  },
  {
    step: '04',
    title: 'Deliver',
    description:
      'You enjoy a flawless event. We follow up to ensure complete satisfaction.',
  },
];
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to bottom, rgba(12,12,12,0.55) 0%, #0C0C0C 90%)',
          }}
        />
        <div
          style={{
        ...
        >
          <AnimatedSection>
            ...
            >
              From intimate private gatherings to large-scale international
              conferences, we offer a comprehensive suite of event services
      ...
      <section style={{ padding: '64px 0', backgroundColor: '#0C0C0C' }}>
        ...
        >
          ...
          >
                  ...
                  {hasImage ? (
                    ...
                    >
                      ...
                      >
                        <Image
                          src={
                            (service as typeof service & { image: string })
                              .image
                          }
                          alt={service.title}
                          fill
            ...
            <div
              className="ef-services-cta"
              style={{ gridColumn: 'span 3', minHeight: '100%' }}
            >
              <AnimatedSection delay={services.length * 60} className="h-full">
                <Link
                  ...
                  style={{
                    ...
                    backgroundColor: '#111111',
                    backgroundImage:
                      'url(/images/54602042741_a0a9895dd9_o.jpg)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    padding: '40px 32px',
                    height: '100%',
                ...
                >
                  ...
                  <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                      Need a Custom{' '}
                      <span style={{ color: '#C41B1B' }}>Solution?</span>
                    </h2>
                    <p
                      style={{
                        fontFamily: 'var(--font-inter), Inter, sans-serif',
                    ...
                    >
                      We tailor our services to fit your unique event needs. Get
