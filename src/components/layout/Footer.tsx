...
const socials = [
  {
    icon: Instagram,
    href: 'https://www.instagram.com/eventsfactoryrw/',
    label: 'Instagram',
  },
  {
    icon: Facebook,
    href: 'https://www.facebook.com/eventsfactoryrwanda',
    label: 'Facebook',
  },
  {
    icon: () => (
  ...
  {
    icon: Youtube,
    href: 'https://www.youtube.com/@EventsFactoryRw',
    label: 'YouTube',
  },
  {
    icon: LinkedInIcon,
    href: 'https://www.linkedin.com/company/events-factory-rwanda/',
    label: 'LinkedIn',
  },
  {
    icon: FlickrIcon,
    href: 'https://www.flickr.com/people/199472815@N07/',
    label: 'Flickr',
  },
  {
    icon: TikTokIcon,
    href: 'https://www.tiktok.com/@eventsfactoryrw',
    label: 'TikTok',
  },
];
...
export default function Footer() {
  return (
    ...
    >
      <div
        style={{ maxWidth: '1280px', margin: '0 auto', padding: '64px 24px' }}
      >
        <div className="ef-grid-footer">
          ...
          <div>
            ...
            >
              Rwanda&apos;s premier event management company. We craft
        ...
        >
          ...
          <div style={{ width: '1px', height: '40px', backgroundColor: '#222222' }} />
          <div
            style={{
              border: '1px solid #222222',
              padding: '12px 20px',
          ...
          >
            <Image
              src="/ICCA_Member_Colour_A.20230510.png"
              alt="ICCA Member"
              width={120}
              height={60}
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Events Factory Rwanda. All rights
            reserved.
          </p>
        </div>
      </div>
