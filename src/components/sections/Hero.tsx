...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <iframe
          src="https://www.youtube.com/embed/KIsRlfqPOCY?autoplay=1&mute=1&loop=1&playlist=KIsRlfqPOCY&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&enablejsapi=1&iv_load_policy=3&disablekb=1"
